...
def main():
    ...
    # target point cloud
    target_xy_list = np.random.random((10, 2))
    ...
    for target_point in target_point_cloud:
        ...
        ax.plot([nearest_xy[0], target_xy[0]], [nearest_xy[1], target_xy[1]], "-g")

    ax.set_aspect("equal")
    ax.grid()
    ax.set_title("Blue o: Source points, Red x: Target points, Green -: Nearest line")
