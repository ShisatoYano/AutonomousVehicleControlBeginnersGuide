...
sys.path.append(abs_dir_path + relative_path + "plan/q_learning")
...
from q_learning_path_planner import QLearningPathPlanner  # noqa: E402
...
def main():
    ...
    sim_dir = (
        ...
        + "path_planning/q_learning_path_planning/"
    )
    map_path = sim_dir + "map.json"
    path_filename = sim_dir + "path.json"
    search_gif_path = sim_dir + "q_learning_search.gif"
    navigate_gif_path = sim_dir + "q_learning_navigate.gif"
    ...
    if not planner.path:
        print("Q-learning: no path found - aborting.")
        return
