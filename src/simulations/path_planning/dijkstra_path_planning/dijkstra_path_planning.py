...
from dijkstra_path_planner import DijkstraPathPlanner
...
def main():
    ...
    navigation_gif_path = abs_dir_path + relative_simulations + "path_planning/dijkstra_path_planning/dijkstra_navigate.gif"
    map_path = abs_dir_path + relative_simulations + "path_planning/dijkstra_path_planning/map.json"
    path_filename = abs_dir_path + relative_simulations + "path_planning/dijkstra_path_planning/path.json"
    search_gif_path = abs_dir_path + relative_simulations + "path_planning/dijkstra_path_planning/dijkstra_search.gif"
    ...
    # Easy Goal = (50,22)
    # Hard Goal = (50,-10)
    planner = DijkstraPathPlanner((0, 0), (50, -10), map_path, x_lim=x_lim, y_lim=y_lim, path_filename=path_filename, gif_name=search_gif_path)
