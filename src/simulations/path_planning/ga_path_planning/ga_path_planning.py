...
sys.path.append(abs_dir_path + relative_path + "plan/ga")
...
from genetic_algorithm_path_planner import GeneticAlgorithmPathPlanner  # noqa: E402
...
def main():
    ...
    sim_dir = (
        ...
        + "path_planning/ga_path_planning/"
    )
    map_path = sim_dir + "map.json"
    path_filename = sim_dir + "path.json"
    search_gif_path = sim_dir + "ga_search.gif"
    navigate_gif_path = sim_dir + "ga_navigate.gif"
    ...
    if not planner.path:
        print("GA: no path found - aborting.")
        return
