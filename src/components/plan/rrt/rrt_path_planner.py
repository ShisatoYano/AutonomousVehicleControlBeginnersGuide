...
This module implements the RRT (Rapidly-exploring Random Tree) algorithm for path planning.
RRT is a sampling-based algorithm that efficiently finds collision-free paths in high-dimensional
configuration spaces by randomly sampling points and incrementally building a tree structure.
"""
...
class RrtPathPlanner:
    def __init__(self, start, goal, map_file, x_lim=None, y_lim=None, path_filename=None, gif_name=None, max_iterations=5000, step_size=0.5, goal_sample_rate=0.05):
        """
    ...
    def search(self):
        ...
        parent = {0: None}  # Parent relationship in the tree (maps node index to parent index)
        ...
        for iteration in range(self.max_iterations):
            ...
            nearest_node_idx = nodes.index(nearest_node)
            ...
            parent[node_idx] = nearest_node_idx  # Store the parent index, not the node tuple
